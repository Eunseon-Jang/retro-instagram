...
$(document).ready(function () {
  (function () {
    axios.get('https://api.instagram.com/v1/users/self/?access_token=1387185290.543433f.4b71ac6a690943c7bcf2d9d69dc7ad26').then(function (_ref) {
      var data = _ref.data;
      console.log(data);
      ...
      $('.user_img').css("background-image", "url(".concat(data.data.profile_picture, ")"));
    });
    axios.get('https://api.instagram.com/v1/users/self/media/recent/?access_token=1387185290.543433f.4b71ac6a690943c7bcf2d9d69dc7ad26').then(function (_ref2) {
      var data = _ref2.data;
      console.log(data);
      var itemList = data.data.map(function (item) {
        if (item.carousel_media) {
          return {
            images: item.carousel_media,
            user: item.user,
      ...
      var thumbList = data.data.map(function (item) {
        return {
      ...
      itemList.map(function (item, index) {
        ...
        item.images.map(function (image) {
          ...
          var images = "";
          images += "\n\t\t\t\t\t\t\t\t<div>\n\t\t\t\t\t\t\t\t\t".concat(ele, "\n\t\t\t\t\t\t\t\t</div>");
          $("#post_idx_".concat(current_idx, " .images_wrap > div")).append(images);
        });
      });
      setTimeout(function () {
      ...
      var createThumbnail = function createThumbnail() {
        thumbList.map(function (item) {
          var template = '';
          template += "\n\t\t\t\t\t\t<a class=\"image insta-image\" href=\"#none\">\n\t\t\t\t\t\t\t<span class=\"media_type ".concat(item.type, "\">").concat(item.type, "</span>\n\t\t\t\t\t\t\t<img alt=\"\" src=\"").concat(item.thumbnail.url, "\" width=\"").concat(item.thumbnail.width, "\">\n\t\t\t\t\t\t</a>\n\t\t\t\t\t\t");
      ...
      var infinityScroll = function infinityScroll() {
        var win = $("#medias");
        win.scroll(function () {
          var winHeight = $("#medias").height();
          var winScrollTop = winHeight + win.scrollTop();
  ...
  var close_popup = function () {
    ...
    $pop_btns.on('click', 'button', function (e) {
      if ($(e.currentTarget).hasClass('pop_submit')) {
        console.log('submit'); // $(e.currentTarget).parents('.popup').removeClass('is-active');
      } else if ($(e.currentTarget).hasClass('pop_cancel')) {
        console.log('cancel'); // $(e.currentTarget).parents('.popup').removeClass('is-active');
      }
    });
  }();
  ...
  if ($('.content_sort_lst').length) {
    // oSortImgList.init();
    var sortImgList = new oSortImgList({
      wrapper: ".content_sort_lst",
      btn: "button",
      list: "#medias"
    });
...
var oSortImgList = function () {
  ...
  var changeListStyle = function changeListStyle(oImgList, sortBy) {
    oImgList.removeAttr('class');
    oImgList.addClass("pic_sort_".concat(sortBy));
  };
...
var OpenPopup = function () {
  function OpenPopup(param) {
    ...
    var openedPopupSet = function openedPopupSet(popupName, popups) {
      popups.find(".".concat(popupName)).parent('.popup').addClass('is-active');
    };
  }
...
/***/ 0:
/*!****************************************************************************************!*\
  !*** multi @babel/polyfill ./src/js/style.js ./src/css/reset.scss ./src/css/main.scss ***!
  \****************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! @babel/polyfill */"./node_modules/@babel/polyfill/lib/index.js");
__webpack_require__(/*! ./src/js/style.js */"./src/js/style.js");
__webpack_require__(/*! ./src/css/reset.scss */"./src/css/reset.scss");
